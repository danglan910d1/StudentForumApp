...
// IMPORTANT: Un-comment io.noties.markwon imports after adding dependency in build.gradle
...
public class PostDetailActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        findViewById(R.id.btnLike).setOnClickListener(v -> {
            Toast.makeText(this, "Calling Like API...", Toast.LENGTH_SHORT).show();
        });
    }
    ...
    private void displayPost(Post post) {
        ...
        // --- HƯỚNG DẪN DÙNG MARKWON ---
        // 1. Thêm dòng này vào build.gradle (app):
        //    implementation "io.noties.markwon:core:4.6.2"
        // 2. Un-comment đoạn code dưới đây để Markwon tự render nội dung sang HTML:
        /*
        Markwon markwon = Markwon.create(this);
        markwon.setMarkdown(tvContent, post.getContent());
        */
        
        // Tạm thời hiển thị text thuần túy
