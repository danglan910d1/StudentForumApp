...
exports.multerErrorHandler = exports.uploadMultipleFiles = exports.uploadSingleAvatar = void 0;
...
const multer_storage_cloudinary_1 = require("multer-storage-cloudinary"); // Bản v4 dùng import trực tiếp được
...
// 4. Export Multer
exports.uploadSingleAvatar = (0, multer_1.default)({
...
const multerErrorHandler = (uploadFunction) => (req, res, next) => {
    const customReq = req;
