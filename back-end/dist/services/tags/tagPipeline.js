...
exports.buildTagAggregationPipeline = void 0;
/**
 * Xây dựng các Aggregation Pipeline Stages cho Tag Model.
 * Hỗ trợ đồng nhất tagId, postCount và bảo mật thông tin theo View.
 */
const buildTagAggregationPipeline = (filter, config = {}) => {
    const { includeTopic = true, includeUser = true, includeProjection = true, isAdminView = false, } = config;
...
exports.buildTagAggregationPipeline = buildTagAggregationPipeline;
//# sourceMappingURL=tagPipeline.js.map