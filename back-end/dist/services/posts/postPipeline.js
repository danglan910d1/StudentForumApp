...
exports.buildPostAggregationPipeline = void 0;
const mongoose_1 = require("mongoose");
const Notification_1 = require("../../models/Notification");
const buildPostAggregationPipeline = (filter, config = {}) => {
    const { includeUser = true, includeTopic = true, includeTags = true, includeProjection = true, isAdminView = false, currentUserId, } = config;
                                ...
                                { $eq: ["$entityId", "$$pId"] },
                                {
                                    $in: [
                                        ...
                                        [
                                            ...
                                            Notification_1.NotificationType.POST_SUBMITTED, // THÊM: Admin thấy vết khi user gửi bài
                                        ],
                                    ],
                                },
                            ],
...
exports.buildPostAggregationPipeline = buildPostAggregationPipeline;
//# sourceMappingURL=postPipeline.js.map