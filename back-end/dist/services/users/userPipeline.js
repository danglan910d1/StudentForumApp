...
exports.buildUserAggregationPipeline = void 0;
const buildUserAggregationPipeline = (filter, config = {}) => {
    const { includeStats = false, includeProjection = true, isAdminView = false, } = config;
...
exports.buildUserAggregationPipeline = buildUserAggregationPipeline;
//# sourceMappingURL=userPipeline.js.map