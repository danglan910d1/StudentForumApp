...
declare const redisClient: import("@redis/client").RedisClientType<{
    json: {
        ...
        ARRINSERT: {
            readonly IS_READ_ONLY: false;
            readonly parseCommand: (this: void, parser: import("@redis/client").CommandParser, key: import("@redis/client").RedisArgument, path: import("@redis/client").RedisArgument, index: number, json: import("@redis/json").RedisJSON, 
            /**
             ...
             * Lấy số lượng Likes hiện tại từ Redis
             * @param postId ID Bài viết
             */jsons: import("@redis/json").RedisJSON[]) => void;
            readonly transformReply: () => import("@redis/client/dist/lib/RESP/types").NumberReply<number> | import("@redis/client/dist/lib/RESP/types").ArrayReply<import("@redis/client/dist/lib/RESP/types").NullReply | import("@redis/client/dist/lib/RESP/types").NumberReply<number>>;
        };
        arrInsert: {
            readonly IS_READ_ONLY: false;
    ...
    ft: {
        ...
        INFO: {
            ...
            readonly transformReply: {
                readonly 2: (reply: any[], preserve?: any, typeMapping?: redis.TypeMapping | undefined) => import("@redis/search/dist/lib/commands/INFO").InfoReply;
                readonly 3: () => import("@redis/client/dist/lib/RESP/types").ReplyUnion;
            };
            readonly unstableResp3: true;
        };
        ...
        SUGGET_WITHSCORES_WITHPAYLOADS: {
            ...
            readonly parseCommand: (this: void, parser: import("@redis/client").CommandParser, key: import("@redis/client").RedisArgument, prefix: import("@redis/client").RedisArgument, options?: import("@redis/search/dist/lib/commands/SUGGET").FtSugGetOptions | undefined) => void;
            readonly transformReply: {
                readonly 2: (reply: import("@redis/client/dist/lib/RESP/types").NullReply | import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>[], preserve?: any, typeMapping?: redis.TypeMapping | undefined) => {
                    suggestion: import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>;
    ...
    ts: {
        ...
        readonly INFO: {
            ...
            readonly parseCommand: (this: void, parser: import("@redis/client").CommandParser, key: string) => void;
            readonly transformReply: {
                readonly 2: (this: void, reply: import("@redis/time-series/dist/lib/commands/INFO").InfoRawReply, _: any, typeMapping?: redis.TypeMapping | undefined) => import("@redis/time-series/dist/lib/commands/INFO").InfoReply;
                readonly 3: () => import("@redis/client/dist/lib/RESP/types").ReplyUnion;
            };
            readonly unstableResp3: true;
        };
        ...
        readonly MGET: {
            ...
            readonly transformReply: {
                readonly 2: (this: void, reply: import("@redis/time-series/dist/lib/commands/MGET").MGetRawReply2, _: any, typeMapping?: redis.TypeMapping | undefined) => import("@redis/client/dist/lib/RESP/types").MapReply<import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>, {
                    sample: {
                        timestamp: import("@redis/client/dist/lib/RESP/types").NumberReply<number>;
                        value: number;
                    };
        ...
        readonly MRANGE_GROUPBY: {
            ...
            readonly transformReply: {
                readonly 2: (this: void, reply: import("@redis/time-series/dist/lib/commands/MRANGE_GROUPBY").TsMRangeGroupByRawReply2, _?: any, typeMapping?: redis.TypeMapping | undefined) => import("@redis/client/dist/lib/RESP/types").MapReply<import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>, {
                    samples: {
                        timestamp: import("@redis/client/dist/lib/RESP/types").NumberReply<number>;
                        value: number;
                    }[];
        ...
        readonly MRANGE_SELECTED_LABELS_GROUPBY: {
            ...
            readonly transformReply: {
                readonly 2: (this: void, reply: import("@redis/time-series/dist/lib/commands/MRANGE_SELECTED_LABELS").TsMRangeSelectedLabelsRawReply2, _?: any, typeMapping?: redis.TypeMapping | undefined) => import("@redis/client/dist/lib/RESP/types").MapReply<import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>, {
                    labels: import("@redis/client/dist/lib/RESP/types").MapReply<import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>, import("@redis/client/dist/lib/RESP/types").NullReply | import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>>;
                    samples: {
                        timestamp: import("@redis/client/dist/lib/RESP/types").NumberReply<number>;
                        value: number;
        ...
        readonly MRANGE_WITHLABELS_GROUPBY: {
            ...
            readonly parseCommand: (parser: import("@redis/client").CommandParser, fromTimestamp: import("@redis/time-series/dist/lib/commands").Timestamp, toTimestamp: import("@redis/time-series/dist/lib/commands").Timestamp, filter: import("@redis/client/dist/lib/commands/generic-transformers").RedisVariadicArgument, groupBy: import("@redis/time-series/dist/lib/commands/MRANGE_GROUPBY").TsMRangeGroupBy, options?: import("@redis/time-series/dist/lib/commands/RANGE").TsRangeOptions | undefined) => void;
            readonly transformReply: {
                readonly 2: (this: void, reply: import("@redis/time-series/dist/lib/commands/MRANGE_WITHLABELS_GROUPBY").TsMRangeWithLabelsGroupByRawReply2, _?: any, typeMapping?: redis.TypeMapping | undefined) => import("@redis/client/dist/lib/RESP/types").MapReply<import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>, {
                    labels: import("@redis/client/dist/lib/RESP/types").MapReply<import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>, import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>>;
        ...
        readonly MRANGE_WITHLABELS: {
            ...
            readonly parseCommand: (parser: import("@redis/client").CommandParser, fromTimestamp: import("@redis/time-series/dist/lib/commands").Timestamp, toTimestamp: import("@redis/time-series/dist/lib/commands").Timestamp, filter: import("@redis/client/dist/lib/commands/generic-transformers").RedisVariadicArgument, options?: import("@redis/time-series/dist/lib/commands/RANGE").TsRangeOptions | undefined) => void;
            readonly transformReply: {
                readonly 2: (this: void, reply: import("@redis/time-series/dist/lib/commands/MRANGE_WITHLABELS").TsMRangeWithLabelsRawReply2, _?: any, typeMapping?: redis.TypeMapping | undefined) => import("@redis/client/dist/lib/RESP/types").MapReply<import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>, {
        ...
        readonly MRANGE: {
            ...
            readonly parseCommand: (parser: import("@redis/client").CommandParser, fromTimestamp: import("@redis/time-series/dist/lib/commands").Timestamp, toTimestamp: import("@redis/time-series/dist/lib/commands").Timestamp, filter: import("@redis/client/dist/lib/commands/generic-transformers").RedisVariadicArgument, options?: import("@redis/time-series/dist/lib/commands/RANGE").TsRangeOptions | undefined) => void;
            readonly transformReply: {
                readonly 2: (this: void, reply: import("@redis/time-series/dist/lib/commands/MRANGE").TsMRangeRawReply2, _?: any, typeMapping?: redis.TypeMapping | undefined) => import("@redis/client/dist/lib/RESP/types").MapReply<import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>, {
                    timestamp: import("@redis/client/dist/lib/RESP/types").NumberReply<number>;
                    value: number;
                }[]>;
    ...
    tDigest: {
        ...
        readonly BYRANK: {
            ...
            readonly transformReply: {
                2: (reply: import("@redis/client/dist/lib/RESP/types").BlobStringReply<string>[], preserve?: any, typeMapping?: redis.TypeMapping | undefined) => import("@redis/client/dist/lib/RESP/types").DoubleReply<number>[];
 ...
 */
export declare function setCache(key: string, value: any, expirationInSeconds?: number): Promise<void>;
/**
 ...
 */
export declare function incrementPostView(postId: string): Promise<void>;
/**
 ...
 */
export declare function togglePostLike(postId: string, userId: string, action: "add" | "remove"): Promise<number>;
/**
 * Lấy số lượng Likes hiện tại từ Redis
 * @param postId ID Bài viết
 */
export declare function getPostLikeCount(postId: string): Promise<number>;
/**
 ...
 */
export declare function checkRateLimit(uniqueKey: string, // KHÓA DUY NHẤT (bao gồm prefix, identifier, và actionId)
limit: number, windowInSeconds: number): Promise<boolean>;
/**
 ...
 */
export declare function clearRateLimitsByIdentifier(identifier: string, keyPrefix: string): Promise<void>;
/**
 ...
 */
export declare function handleLoginFailure(email: string, userIp: string): Promise<void>;
/**
 ...
 * @param email Email của user
 */
export declare function clearLoginFailure(email: string): Promise<void>;
/**
 * Kiểm tra xem tài khoản có đang bị khóa tạm thời do nhập sai mật khẩu quá nhiều lần không.
 * @param email Email của user
 * @returns true nếu bị khóa
 */
export declare function isAccountLockedOut(email: string): Promise<boolean>;
/**
 ...
 */
export declare function cacheUser(userId: string, userData: any, expirationInSeconds?: number): Promise<void>;
/**
 * Lấy thông tin người dùng từ cache
 * @param userId ID người dùng
 * @returns Dữ liệu người dùng hoặc null
 */
export declare function getCacheUser(userId: string): Promise<any | null>;
/**
 ...
 */
export declare function addRevokedToken(jwtId: string, expirationInSeconds: number): Promise<void>;
/**
 ...
 */
export declare function isTokenRevoked(jwtId: string): Promise<boolean>;
/**
 ...
 */
export declare function reserveIdempotencyKey(requestId: string, expirationInSeconds?: number): Promise<boolean>;
/**
 * Xóa Idempotency Key sau khi request đã hoàn tất.
 * @param requestId Idempotency Key (x-request-id)
 */
export declare function releaseIdempotencyKey(requestId: string): Promise<void>;
export declare function saveIdempotencyResult(requestId: string, statusCode: number, responseBody: string, expirationInSeconds?: number): Promise<boolean>;
export declare function getIdempotencyKey(requestId: string): Promise<string | null>;
/**
 ...
 */
export declare function setOTP(userId: string, otp: string, action?: string, // Cập nhật mặc định thành reset-password
expirationInSeconds?: number): Promise<void>;
/**
 ...
 */
export declare function getOTP(userId: string, action?: string): Promise<string | null>;
/**
 * Xóa OTP ngay lập tức sau khi xác thực thành công (Tránh dùng lại).
 * @param userId ID người dùng
 * @param action Loại tác vụ
 */
export declare function deleteOTP(userId: string, action?: string): Promise<void>;
